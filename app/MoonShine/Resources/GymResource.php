...
class GymResource extends ModelResource
{
    ...
    protected function indexFields(): iterable
    {
        return [
            ...
            Text::make('Тип', 'type')->badge(),
            Text::make('Телефон', 'phone')->copy(),
        ];
    }

//    protected function beforeCreating(mixed $item): DataWrapperContract
//    {
////        $item->slug = str_replace(' ', '-', strtolower($this->getItem()->name));
//        return $item;
//    }
//
//    protected function beforeUpdating(mixed $item): DataWrapperContract
//    {
